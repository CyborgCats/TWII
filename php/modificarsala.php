<?php 
    ...
    $sql = "SELECT * FROM prestamosalas WHERE NroPrestamoSala = '$NroPrestamoSala'";
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                  <form method="POST" action="updateprestamosala.php" autocomplete="off">
                    <div class="form-row">

                      <div class="form-group col-md-12">
                        <label for="inputEmail4">Fecha de Inicio</label>
                        <input type="text" class="form-control" id="fechainicio" name="fechainicio"  value="<?php echo $row['FechaInicio']; ?>" required>
                      </div>

                      <div class="form-group col-md-12">
                        <label for="inputPassword4">Fecha de Fin</label>
                        <input type="text" class="form-control" id="fechafin" name="fechafin"  value="<?php echo $row['FechaFin']; ?>" required>
                      </div>
                      
                      <input type="hidden" name="nroprestamosala" id="nroprestamosala" value="<?php echo $row['NroPrestamoSala']; ?>">

                    </div>

                    <div class="form-group col-md-12">
                      <label for="inputAddress">Detalle</label>
                      <input type="text" class="form-control"  id="detalle" name="detalle"  value="<?php echo $row['Detalle']; ?>" required>
                    </div>

                    <div class="form-group col-md-12">
                      <label for="inputAddress2">C.I. Docente</label>
                      <input type="number" class="form-control"  id="cidocente" name="cidocente"  value="<?php echo $row['NroCIDocente']; ?>" required>
                    </div>

                    <div class="form-group col-md-12">
                      <label for="inputAddress2">Codigo Sala</label>
                      <input type="number" class="form-control"  id="codsala" name="codsala"  value="<?php echo $row['CodigoSala']; ?>" required>
                    </div>
