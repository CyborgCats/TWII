            ...
            <div class="panel panel-default">
              ...
              <?php
                require 'conexion.php';
                 ...
                 $idprestamoaccesorio = $_POST['idprestamoaccesorio'];
                 $nroprestamo = $_POST['nroprestamo'];
                 $cidocente = $_POST['cidocente'];

                 $sql = "INSERT INTO prestamoaccesorio (PrestamoID, NroPrestamo, NroCIDocente, PrestamoAccesorioDetalleID) values ('$idprestamoaccesorio', '$nroprestamo', '$cidocente')";
