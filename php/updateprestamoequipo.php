            ...
            <div class="panel panel-default">
              ...
              <?php
                require 'conexion.php';
                 ...
                 $nroprestamoequipo = $_POST['nroprestamoequipo'];
                 $horaingreso = $_POST['horaingreso'];
                 $horasalida = $_POST['horasalida'];
                 $ciestudiante = $_POST['ciestudiante'];
                 $equipo = $_POST['equipo'];

                 $sql = "UPDATE prestamoequipos SET HoraIngreso='$horaingreso', HoraSalida='$horasalida', NroCIEstudiante='$ciestudiante',
                 NroEquipo='$equipo' WHERE NroPrestamoEquipo='$nroprestamoequipo'";
                 $resultado = $mysqli->query($sql);
              ?>

                  <?php if($resultado) { ?>
                    <h3>Accesorio modificado correctamente!</h3>
                  <?php } else { ?>
