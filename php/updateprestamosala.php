            ...
            <div class="panel panel-default">
              ...
              <?php
                require 'conexion.php';
                 ...
                 $nroprestamosala = $_POST['nroprestamosala'];
                 ...
                 $sql = "UPDATE prestamosalas SET FechaInicio='$fechainicio', FechaFin='$fechafin', Detalle='$detalle',
                 NroCIDocente='$cidocente', CodigoSala='$codsala' WHERE NroPrestamoSala='$nroprestamosala'";
                 $resultado = $mysqli->query($sql);
              ?>

                  <?php if($resultado) { ?>
                    <h3>Préstamo de modificado correctamente!</h3>
                  <?php } else { ?>
