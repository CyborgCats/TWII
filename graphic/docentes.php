        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="list-group">
                ...
                <a href="accesorios.php" class="list-group-item"><span class="glyphicon glyphicon-book" aria-hidden="true"></span> Existencia de Accesorios <span class="badge"></span></a>
                <a href="docentes.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-cd" aria-hidden="true"></span> Docentes y Accesorios <span class="badge"></span></a>
            </div>
          </div>
          <div class="col-md-9">
            <!-- Website Overview -->
                                    ...
                                    data:[
                                        <?php
                                            ...
                                            while($registros=mysqli_fetch_array($result))
                                            {
                                                ?>
                                                //Generar la cadena con los datos de la BD
                                                <?php echo $registros["NroCIDocente"] ?>,
